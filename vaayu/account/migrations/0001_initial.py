# Generated by Django 3.0.8 on 2021-05-06 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_donar', models.OneToOneField(default='', on_delete=django.db.models.deletion.CASCADE, related_name='profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Equipments',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_ngo', models.OneToOneField(default='', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Requirements',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eqi_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.Equipments')),
                ('ngo_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.NGO')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.Donar')),
            ],
        ),
    ]
