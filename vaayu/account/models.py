...
class Donar(models.Model):
    user_donar = models.OneToOneField(User,on_delete=models.CASCADE,default="",related_name="profile")
    Address = models.TextField(max_length=1000,null=False)
    country = models.CharField(max_length=100,null=False)
    pincode = models.IntegerField()

class NGO(models.Model):
    user_ngo = models.OneToOneField(User,on_delete=models.CASCADE,default="")
